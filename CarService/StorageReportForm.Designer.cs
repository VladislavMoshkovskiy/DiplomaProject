...
{
    partial class StorageReportForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "Storage";
            reportDataSource1.Value = this.materialsBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "CarService.StorageReport.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.ServerReport.BearerToken = null;
            this.reportViewer1.Size = new System.Drawing.Size(920, 548);
            ...
            this.materialsBindingSource.DataSource = this.CarServiceDataSet;
            // 
            // StorageReportForm
            // 
            ...
            this.Name = "StorageReportForm";
            this.Text = "Звіт по складу";
            this.Load += new System.EventHandler(this.StorageReportForm_Load);
